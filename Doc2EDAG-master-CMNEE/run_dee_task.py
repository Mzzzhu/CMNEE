...
def parse_args(in_args=None):
    ...
    arg_parser.add_argument('--task_name', type=str, default='DEEEDAGCMNEE',
                            help='Take Name')
    arg_parser.add_argument('--data_dir', type=str, default='./data',
                            help='Data directory')
    arg_parser.add_argument('--exp_dir', type=str, default='./Exps2',
    ...
    arg_parser.add_argument('--keep_ratio', type=strtobool, default=False,
                            help='Whether to re-evaluate previous predictions')
