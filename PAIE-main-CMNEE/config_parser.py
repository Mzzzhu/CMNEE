...
def get_args_parser():
    ...
    parser.add_argument("--model_name_or_path", default="../../../../MODELS/bart-base-chinese", type=str,
                        help="pre-trained language model")
    parser.add_argument("--dataset_type", default="cmnee", choices=["ace_eeqa", "rams", "wikievent","cmnee"], type=str,
                        help="dataset type. Both sentence-level(ace_eeqa) and document-level(rams/wikievent)")
    parser.add_argument("--role_path", default='./data/dset_meta/description_cmnee.csv', type=str,
                        help="a file containing all role names. Read it to access all argument roles of this dataset")
    parser.add_argument("--prompt_path", default='./data/prompts/prompts_cmnee_full.csv', type=str,
    ...
    parser.add_argument("--keep_ratio", default=1, type=float,
    ...
    parser.add_argument("--max_enc_seq_length", default=1024, type=int,
    ...
    parser.add_argument("--max_dec_seq_length", default=50, type=int,
    ...
    parser.add_argument("--max_prompt_seq_length", default=512, type=int,
