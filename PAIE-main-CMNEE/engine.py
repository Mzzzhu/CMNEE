...
def run(args, model, processor, optimizer, scheduler):
    ...
    # logger.info("sample dataloader generation")
    # sample_examples, sample_features, sample_dataloader, args.sample_invalid_num = processor.generate_dataloader('sample')
