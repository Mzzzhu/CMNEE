...
_DATASET_DIR = {
    ...
    "cmnee":{
        "train_file": '../dataset/cmnee_paie/train.unified.jsonl',
        "dev_file": '../dataset/cmnee_paie/valid.unified.jsonl',
        "test_file": '../dataset/cmnee_paie/test.unified.jsonl',
        "sample_file": '../dataset/cmnee_paie/sample.unified.jsonl',
        "max_span_num_file": "./data/dset_meta/role_num_cmnee.json",
    },
}
...
def build_processor(args, tokenizer):
    ...
    args.sample_file = _DATASET_DIR[args.dataset_type]['sample_file']
