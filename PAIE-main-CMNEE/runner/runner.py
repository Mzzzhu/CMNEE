...
class Runner(BaseRunner):
    ...
    def report_result(self, dev_c, test_c, global_step=None):
        ...
        # get_pred_result(self.test_features, os.path.join(self.cfg.output_dir, f'best_test_related_results.json'))
        # get_pred_result(self.dev_features, os.path.join(self.cfg.output_dir, f'best_dev_results.json'))